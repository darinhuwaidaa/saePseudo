...
#' \item Calculate \eqn{y_{k} = \beta_{0}+\beta_{1}∗x_{1}+\beta_{2}∗x_{2}}
#' \item Generate number of sample with simple random sampling with replacement
#' \item Calculate \eqn{ydir_area4 = \frac{\Sigma{y_{k}}}{n}}, \eqn{vardir_area4 = \frac{\Sigma{(Y-\frac{\Sigma{y_{k}}}{n})^2}}{n-1}}, and auxiliary variable \eqn{X1 = \frac{\Sigma{x1_{k}}}{n}}
